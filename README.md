...
[![Oportunitati SI Cariere](https://github.com/sebiboga/smedix-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml/badge.svg)](https://github.com/sebiboga/smedix-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml)
[![Automation Tests](https://github.com/sebiboga/smedix-nodejs-scraper/actions/workflows/automation-testing.yml/badge.svg)](https://github.com/sebiboga/smedix-nodejs-scraper/actions/workflows/automation-testing.yml)

[![Version](https://img.shields.io/github/package-json/v/sebiboga/smedix-nodejs-scraper?label=version&color=blue)](CHANGELOG.md)
[![Test Results](https://img.shields.io/badge/test--results-HTML-9b59b6)](https://sebiboga.github.io/smedix-nodejs-scraper/test-results/)
...
[![GitHub Pages](https://img.shields.io/github/deployments/sebiboga/smedix-nodejs-scraper/github-pages?label=GitHub%20Pages)](https://sebiboga.github.io/smedix-nodejs-scraper/)
...
Proiectul automatizează colectarea zilnică a job-urilor SMEDIX din România, menținând board-ul peviitor.ro la zi cu cele mai recente oportunități de carieră.

## Features

- Extrage job-uri din API-ul public Perficient Careers Romania
...
│   ├── e2e/
│   │   └── scraper.test.js     # Full pipeline tests with real Perficient API
│   └── consistency/
...
3. Scrapes current job listings from Perficient Careers
...
7. Generates [`docs/jobs.md`](https://sebiboga.github.io/smedix-nodejs-scraper/jobs.md) with company info and all scraped jobs
8. Pushes test reports and `docs/jobs.md` to [`docs/`](https://sebiboga.github.io/smedix-nodejs-scraper/)
...
4. Pushes test reports to [`docs/test-results/`](https://sebiboga.github.io/smedix-nodejs-scraper/test-results/)
...
Acest scraper respectă regulile din [robots.txt](https://careers.perficient.com/robots.txt) al Perficient Careers. Pentru analiza completă, vezi [ROBOTS.md](ROBOTS.md).
...
This scraper is designed for educational purposes and legitimate job data aggregation for the Romanian job market. Please respect Perficient's Terms of Service and robots.txt when using this scraper.
